...
public class ZeldaBossRoom extends TiledImageRoom {
	
	private static Image WALL_TEST, DUNGEON_FLOOR;

	public ZeldaBossRoom(GameWorld gameWorld) {
		this(gameWorld, 0 , 0);
		/*setRoomType(RoomType.ZELDA_ROOM_BOSS);
	...
	public ZeldaBossRoom(GameWorld gameWorld, int row, int col) {
